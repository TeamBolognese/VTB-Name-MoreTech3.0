...
const kSurveyComplete =
    "У меня для тебя кое-что есть ... \nЯ хочу подарить тебе цветок. Он будет отражать твои успехи и неудачи в инвестировании. Сука, я не придумал, че сюда написать, ну крч будут норм дела с торгами - будет заебатый цветок.";
