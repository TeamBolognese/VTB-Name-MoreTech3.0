...
class QuizCorrectScreen extends StatelessWidget {
  QuizCorrectScreen(
      {Key? key, required this.question, required this.answerIndex})
      : super(key: key);
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Image.asset(
                "lib/assets/farmer_speech/farmer-speech-correct-answer.png"),
            SizedBox(height: 24),
            Padding(
              padding: hPadding12,
              child: Column(
            ...
            Text(
              question.trueAnswer
                  .firstWhere((element) =>
                      element.answer == question.answers[answerIndex])
                  .explanation,
              style: textStyle(16, textColor),
            ),
            SizedBox(height: 42),
